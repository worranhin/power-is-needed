...
export class MainGame extends Scene {
    ...
    create() {
        ...
        // this.camera.setBackgroundColor('rgb(0, 0, 0)');
        ...
        this.input.enableDebug(city);  // TODO: TEST
    ...
    updateText() {
        this.text.setText([
            ...
            `Pointer: x:${Math.floor(this.input.activePointer.x)}, y:${Math.floor(this.input.activePointer.y)}`]);
    ...
    handleObjectDown(_pointer: Phaser.Input.Pointer, gameObject: Phaser.GameObjects.GameObject) {
        ...
        if (this.pointerState === PointerState.Normal) {
            ...
            if (this.citys.contains(gameObject)) {  // target of connectioon
                ...
                // this.connect(station, pline);
                // this.connect(pline, city);
                ...
                this.powerGrids.push(grid);
                // station.grid?.merge(this.connectFrom?.grid as PowerGrid);
                // this.powerGrids.splice(this.powerGrids.indexOf(this.connectFrom?.grid as PowerGrid), 1);
                // this.powerGrids.push(station.grid as PowerGrid);
